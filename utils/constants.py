...
SERVER_ANNOUNCEMENTS       = 941737024602378282 if is_test else 756967122092949524

MOVIE_ROLE                 = 946454378137653282 if is_test else 903667495922180167
GAME_ROLE                  = 946454413298520114 if is_test else 903667578549968896

NEWEST_MAPS_ID             = 856602254769782835 if is_test else 856605387050188821
MAP_MAKER_ID               = 932337184231522405 if is_test else 746167804121841744
...
HALL_OF_FAME_ID            = 931959281845157978 if is_test else 840614462494081075
